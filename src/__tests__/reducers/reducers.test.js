...
import {onClearClick,onNumClick,onEqualClick,onOpeClick} from '../../actions/index';
...
it("When operator is clicked",()=>{
    ...
    expect(calculator(state,onOpeClick(operators.PLUS))).toEqual(expectedState);
    expect(onOpeClick(operators.PLUS)).toEqual({operator:"PLUS",type:"INPUT_OPERATOR"})
  })
